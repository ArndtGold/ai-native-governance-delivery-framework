...
| CHMCP-TP-16 | done | Root, install and package READMEs plus `CG-MCP-DISPATCH-ADAPTER` document native sources, evidence and authority boundaries |
| CHMCP-TP-17 | done | Release assets regenerated; focused and complete suites passed; this report records failures, correction and remaining gaps |
...
| CHMCP-TP-22 | done | Final TP, clean and code reviews pass; QA Revision 1 records `pass` and awaits exact approval |
...
Revision 1, then provide exact `Approval: QA` or request a revision.
