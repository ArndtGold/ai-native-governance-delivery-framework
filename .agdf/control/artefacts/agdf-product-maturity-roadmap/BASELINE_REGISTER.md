...
| baseline_id | existing_run | covered_requirements | state | evidence_class | limitation | next_action |
|---|---|---|---|---|---|---|
| BL-01 | [`task-target-resolution-boundary`](../../runs/task-target-resolution-boundary/RUN_STATE.md) | PMR-2, PMR-3, PMR-5, PMR-7 | `accepted` | `user_accepted` | QA/UAT und 47/47 Replays beweisen kein reales Attachment-/Mehrturn-Hostverhalten | akzeptierten OR als Target-Authority-Evidenz wiederverwenden; Hostgrenze beibehalten |
| BL-02 | [`agdf-interaction-ownership-quick-path-ux`](../../runs/agdf-interaction-ownership-quick-path-ux/RUN_STATE.md) | PMR-1, PMR-2, PMR-5, PMR-7 | `accepted` | `user_accepted` | direktes installiertes Codex-/Claude-/OpenCode-Verhalten bleibt teilweise unverified | akzeptierten OR als Interaction-/Compact-Delivery-Evidenz wiederverwenden; Hostgrenze beibehalten |
| BL-03 | [`opencode-single-install-activation`](../../runs/opencode-single-install-activation/RUN_STATE.md) | PMR-2, PMR-3, PMR-5 | `accepted` | `user_accepted` | reale OpenCode-Aktivierung und Host-Konsum bleiben unperformed post-release evidence | akzeptierten OR als Single-Install-Evidenz wiederverwenden; Hostgrenze beibehalten |
