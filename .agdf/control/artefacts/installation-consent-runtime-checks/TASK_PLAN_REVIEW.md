...
| IRC-06 | fully_done | disclosure and enable/manual/cancel behavior | Codex choice remains native | evidence gap |
...
| IRC-10 | fully_done | CLI/lifecycle output observed in real installers | none | none |
...
|---|---|---|---|---|---|
| PRD-IC-01/02 | disclosure and deliberate choice | IRC-06/10 | installer output and Codex review | fulfilled | none |
...
|---|---|---|---|---|---|
| TPR-01 | evidence_gap | evidence_obligation | open | Codex trust/enabled cycle, IRC-H04 through H07 and selected destructive cases remain unverified | Complete the remaining direct-host cells without inferred parity. |
...
- risks: Codex enabled state remains a user decision; native Windows and rendered listing are absent
