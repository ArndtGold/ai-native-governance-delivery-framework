...
2. Use `plugin/meta/agdf-runtime-contract.md` for repeated gate, quality-contract, and closeout output rules.
3. Reuse the skill definitions in `plugin/skills/*/SKILL.md` as the operative behavior reference.
