...
import { runRequestActivationBehavioralEvaluation } from "../lib/request-activation-evals/behavioral.js";

const repoRoot = resolve(dirname(fileURLToPath(import.meta.url)), "../..");
const allowedOptions = new Set(["--input-mode", "--profile-surface", "--evaluator-surface", "--surface", "--model", "--case"]);
const option = (name) => {
...
try {
  ...
  console.error(`Request Activation behavioral evaluation failed: ${error.message}`);
  process.exitCode = 1;
}
