...
export const compatibility = [
    { tool: "OpenCode", integration: "global npm/native skills + native repo skills, instructions and permissions", support: "Control-stack reference", goal: "runtime", setupAnchor: "#setup-opencode" },
