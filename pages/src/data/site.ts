...
export const compatibility = [
    { tool: "OpenCode", integration: "npm plugin + native repo skills, instructions and permissions", support: "Control-stack reference", goal: "runtime", setupAnchor: "#setup-opencode" },
