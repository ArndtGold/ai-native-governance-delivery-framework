...
|---|---|---|
| `brownfield-analysis` | before non-trivial implementation in existing systems | clarifies reuse, owners and risks |
...
| `gate-check` | unclear approval, Structured Delivery, later-gate artefact requested | does not create later artefacts |
